...
export class SwipeActions extends PureComponent<SwipeToRemoveProps, SwipeToRemoveState> {
    ...
    private didPanResponderGrant = false;
    private gestureStartPosition: number;
    ...
    constructor(props, state) {
        ...
        this._panResponder = PanResponder.create({
            onStartShouldSetPanResponder: (e, g) => {
                console.log('start called', g);
                this.gestureStartPosition = e.nativeEvent.pageX;
                return false;
            },
            ...
            onPanResponderGrant: () => {
                this.didPanResponderGrant = true;
            },
    ...
    private onPanResponderEnd() {
        this.didPanResponderGrant = false;
    ...
    private onMoveShouldSetPanResponder(ev: GestureResponderEvent, gesture: PanResponderGestureState) {
        ...
        return this.didUserSwipeEnough(ev, gesture);
    }
    ...
    private didUserSwipeEnough(ev: GestureResponderEvent, gesture: PanResponderGestureState) {
        console.log( Math.abs(gesture.dx) > 50);
        const isThresholdExceeded = Math.abs(gesture.dx) > 50;
    ...
    private updateCurrentPosition(gesture: PanResponderGestureState) {
        ...
        this.state.animated.setValue(this.currentPositionDx);
